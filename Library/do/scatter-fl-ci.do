*Figure: Scatter plot with fitted line and confidence interval
    ...
    * Graph
    twoway ///
        ...
        (scatter jobs_scarce_code avg_growth if continent == "Europe", mcolor(ebblue ) m(T) ) ///   Then scatter all the individual regions
      ...
      ,  ///
        xlabel(-5(5)15)         /// (start(increment-by)end) x axis labels
        ...
        ring(0) position(4)) /// legend appears inside plot 
